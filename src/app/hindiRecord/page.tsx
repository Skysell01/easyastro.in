...
//                 </th>
//                 <th>Status</th>
//                 <th className="hide-sm">Add-ons</th>
//                 <th
...
// ✅ Fixed: auth options to stop refresh token errors
const supabase = createClient(
  process.env.NEXT_PUBLIC_ORDERS_SUPABASE_URL!,
  process.env.NEXT_PUBLIC_ORDERS_SUPABASE_ANON_KEY!,
  {
            ...
            <tbody>
              {loading ? (
                <tr className="loader-row">
                  ...
                  <td colSpan={9}><div className="spinner" /></td>
                </tr>
              ) : filtered.length === 0 ? (
                <tr>
                  {/* ✅ colSpan updated to 9 */}
                ...
                filtered.flatMap((row) => {
                  ...
                  return [
                    ...
                    >
                      ...
                      {/* Amount */}
                      <td>
                        <span className="cell-amount">₹{row.amount ?? 0}</span>
                      </td>
                      ...
                      <td className="hide-sm">
                        {row.additional_products?.length > 0 ? (
                          <div style={{ display: "flex", flexWrap: "wrap", gap: "4px" }}>
                            {row.additional_products.map((p) => (
                              <span key={p} className="addon-tag">{p}</span>
                            ))}
                          </div>
                        ) : (
